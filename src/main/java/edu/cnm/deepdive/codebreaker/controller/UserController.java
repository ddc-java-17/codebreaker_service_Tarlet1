...
public class UserController {
  ...
  @Autowired
  public UserController(AbstractUserService userService) {this.userService = userService;}
  ...
  @PutMapping(path = "/me/follows/{followedKey}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
